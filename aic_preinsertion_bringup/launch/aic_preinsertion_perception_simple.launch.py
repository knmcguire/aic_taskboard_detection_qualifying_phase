"""Quick preinsertion perception: zenoh, Gazebo, and table-plane port detection."""
...
def launch_setup(context, *args, **kwargs):
        ...
        FrontendLaunchDescriptionSource(
            PathJoinSubstitution(
                [
                    ...
                    "launch",
                    "component_detection_simple.launch.xml",
                ]
            )
        ),
    ...
    actions.extend(_delayed(detection_startup_delay, [_scoped_include(component_detection)]))
    return actions
    ...
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument(
                ...
                default_value="10.0",
                description="Seconds to wait after launch start before component detection.",
            ),
            DeclareLaunchArgument(
                "use_sim_time",
                default_value="true",
            ...
            DeclareLaunchArgument(
                "debug_viz",
                default_value="true",
                description="Publish 2D detection debug visualizations.",
            ),
            DeclareLaunchArgument(
                "camera_name",
                default_value="center",
                description="Camera used by SC/NIC port detection and ray intersection.",
            ),
            DeclareLaunchArgument(
                "sc_method",
                default_value="yolo",
